...
public class SelectedProduct implements Parcelable {
    ...
    public SelectedProduct(Parcel source) {
        ...
        retailPrice = source.readString();
        prechesPrice= source.readString();
    ...
    public void setPrechesPrice(String prechesPrice) {
        this.prechesPrice = prechesPrice;
    }
    ...
    public void setFree_system(int free_system) {
